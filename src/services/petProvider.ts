 ...
 * Merges local pets.json profile (bio, name, breed) with a real
 * dog photo from dog.ceo — image URL lives at response.message.
 * Returns null when deck is exhausted.
 */
